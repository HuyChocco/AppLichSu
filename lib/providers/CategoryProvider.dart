...
class CategoryProvider extends ChangeNotifier {
  ...
  Future<void> feedData() async {
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/hong_ban.txt',
      'image_path': 'assets/images/thoi_hong_ban.jpg',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/bac_thuoc_1.txt',
      'image_path': 'assets/images/thoi_bac_thuoc_1.jpg',
      'video_path': 'video_path',
      'is_done': 0,
      'number': 3,
    });
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/bac_thuoc_2.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/tu_chu.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/bac_thuoc_4.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/le_so.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/nam_bac_trieu.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/dang_trong_ngoai.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'title': 'Nhà Tây Sơn',
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/tay_son.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/nha_nguyen.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/phap_thuoc.txt',
    ...
    await DBHelper.insert('content', {
      ...
      'id_category': '1',
      'file_path': 'assets/contents/su_kien_lich_su/doi_moi.txt',
